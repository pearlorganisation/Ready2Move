    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-50 py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          {/* <p className="text-gray-600">Last updated: June 20, 2025</p> */}
        </div>
      </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-orange-700 mt-2">
                ...
                please contact{" "}
                <a
                  href="mailto:anurag.gaud@ready2move.co.in"
                  className="text-orange-800 underline hover:text-orange-900"
                >
                  anurag.gaud@ready2move.co.in
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
                ...
                <li className="leading-relaxed">
                  <strong>Website</strong> refers to ready2move.co.in,
                  accessible from https://ready2move.co.in/
                </li>
                <li className="leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div className="bg-red-50 border border-red-200 p-4 rounded-lg mb-4">
                <p className="text-red-800 font-medium leading-relaxed">
                  <strong>Age Restriction:</strong> You represent that you are
                  over the age of 18. The Company does not permit those under 18
                  to use the Service.
                </p>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-4">
                <p className="text-yellow-800 font-medium leading-relaxed">
                  ...
                  as it limits the Company's liability.
                </p>
              </div>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <div className="border-t border-gray-200 mt-8 pt-6">
              <p className="text-sm text-gray-500 text-center">
                Generated using Free Privacy Policy Generator | These Terms and
                Conditions were last updated on June 20, 2025
              </p>
            </div>
          </div>
        </div>
