...
export default function PropertyCard({ project }: { project: SingleProject }) {
  ...
  return (
    <div className="font-sans max-w-3xl mx-auto my-5 bg-white rounded-lg shadow-md overflow-hidden hover:bg-gray-100">
          ...
          <div className="mb-4">
            ...
            <ul className="flex flex-wrap gap-2">
              ...
              {propertyData?.aminities?.map((amenity, index) => (
                <li
                  key={index}
                  className="flex items-center text-xs text-gray-700 bg-gray-100 px-2 py-1 border-2 rounded"
                >
