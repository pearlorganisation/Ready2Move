...
const PaginationMainComponent = ({ paginate, currentPage, totalPages, handlePageClick }: { paginate: Paginate; currentPage: number; totalPages: number; handlePageClick: (page: number) => void }) => {
    return (
        <div>
            <nav
...
export default PaginationMainComponent;
