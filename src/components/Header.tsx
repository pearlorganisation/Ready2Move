    ...
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      <nav className="max-w-screen-xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="absolute top-16 left-0 w-full bg-white shadow-md p-4 hidden peer-checked:block  lg:flex lg:w-auto lg:relative lg:top-0 lg:bg-transparent lg:shadow-none md:space-x-6">
          <a href="#" className="block py-2 px-4 font-semibold text-gray-900 hover:text-blue-700">About Us</a>
          <a href="#" className="block py-2 px-4 font-semibold text-gray-900 hover:text-blue-700">Projects</a>
          <a href="#" className="block py-2 px-4 font-semibold text-gray-900 hover:text-blue-700">Properties</a>
          <a href="#" className="block py-2 px-4 font-semibold text-gray-900 hover:text-blue-700">My Account</a>
