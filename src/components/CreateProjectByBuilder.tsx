...
const CreateProjectBuilderForm: React.FC<CreateProjectBuilderFormProps> = ({
  modalOpen,
}) => {
  ...
  useEffect(() => {
    ...
    // Update ref
    previousPreviewsRef.current = previewImages;
  }, [previewImages]);
        ...
        <div className="flex w-full">
          ...
          <div className="w-full  px-4 py-4">
            <div className="flex justify-end">
              <button className="px-6 py-3 bg-white text-red-500 rounded-md font-semibold shadow-md hover:bg-red-100 transition">
                Add New Project
              </button>
            </div>
          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              {...register("reraPossessionDate", {
                                required: "RERA Possession Date is required",
                              })}
                            />
